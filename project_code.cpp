...
string curr_amount = "0";
string checked_amount = "0";
string total = "0";
...
class fieldwise_Evaluator : public Evaluator 
{
    ...
    public:
        ...
        void eval(string ans, int field_num)
        {
            ...
            {
                curr_amount = curr_amount + bonus_amount[field_num-1];
...
{   
    public:
        ...
        {    
            ...
            cout << " 2. Sports [12 lacs]" << endl;
            cout << " 3. Current Affairs [23 lacs]" << endl;
            cout << " 4. Science and Technology [15 lacs] " << endl;
            cout << " 5. Religion , Culture and Mythology [17 lacs]" << endl;
            cout << " 6. Geography [20 lacs]" << endl;
            cout << " 7. Fashion and Lifestyle [16 lacs] " << endl;
            cout << " 8. Language and Literature [18 lacs] " << endl;
...
static void rules1()
{
    cout << "THE RULES OF THE GAME ARE PRETTY SIMPLE :" << endl;
    sleep(1.75);
    cout << "~> The game consists of total 13 questions with 4 different difficulty levels" <<endl;
    sleep(1.5);
    cout << "~> Each question will have 4 options " << endl;
    sleep(1.75);
    cout << "~> The game will start with the amount of 5,000 and will go upto 70,000,000" << endl;
    sleep(1.5);
    cout << "~> Checkpoints are 80,000 , 25,60,000 and 10,000,000" << endl;
    sleep(1.5);
    cout << "~> If you give wrong answer , then you will get the amount mentioned in the previous checkpoint" << endl;
    sleep(1.5);
    cout << "~> At any point of time , you can escape the game and take home the amount that you have won till the moment" << endl;
    sleep(1.5);
    cout << "~> The game will have five lifelines : " << endl;
    sleep(1.5);
    cout<< " # Flip the question " << endl
        << "# 50 : 50 " << endl
        ...
        << "# Feed the Greed " << endl;
    sleep(1.5);
    cout << "You can flip any question using 'Flip the Question' " << endl;
    sleep(1.5);
    cout << "You can eliminate two incorrect options using '50:50' " << endl;
    sleep(1.5);
    cout << "You can get a hint using 'Expert's Advice' " << endl;
    sleep(1.5);
    cout << "You can consider audience's opinion using 'Audience Poll'" << endl;
    sleep(1.5);
    cout << "After earning 80,000 , you can use ' Feed the Greed ' to get 1.5 times the money on each question for the next 5 questions but you will get multiple correct choice questions" << endl;
    sleep(1.5);
    cout << "If any of your multiple correct choice question is incorrect , you will receive just 80,000 and the game will end" << endl;
    sleep(1.5);
...
static void rules2()
{
    cout << "IMP RULES FOR EVERY QUESTION:" << endl;
    sleep(1.5);
    cout << "Remember , Press A,B,C,D to answer the question " << endl;
    sleep(1.5);
    cout << "Type Lifeline to take a Lifeline" << endl;
    sleep(1.5);
    cout << "Press Quit to escape the game" << endl;
    sleep(1.5);
    cout << "Press '!' for flipping the question" << endl;
    sleep(1.5);
    cout << "Press '%' for 50:50" << endl;
    sleep(1.5);
    cout << "Press '+' for Expert's Advice " << endl;
    sleep(1.5);
    cout << "Press '@' for Audience Poll" << endl;
    sleep(1.5);
    cout << "After winning 80,000 , you can press '&' for feed the greed lifeline" << endl;
    sleep(1.5);
    cout << "You can use maximum one lifeline per question" << endl;
    sleep(1.5);
    cout << "HERE WE BEGIN" << endl;
    sleep(1.5);
}
...
int main()
{
    ...
    cout << "Welcome to the roller-coaster ride of Kaun Banega Crorepati" << endl << endl;
        ...
        try
        {
            ...
            else if (ans=="Lifeline")
            {
                ...
                else
                {
                    ...
                    else if(realanswer=="B")
                    {
                        countB=67;
                    }
                    else if(realanswer=="C")
                    {
                        countC=67;
                    }
                    else
